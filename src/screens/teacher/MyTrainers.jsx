      ...
      <div className="max-w-4xl mx-auto">
        ...
        {trainers.length === 0 ? (
          <div className="text-center py-12">
            <div className="mx-auto mb-4 p-4 rounded-full w-16 h-16 flex items-center justify-center bg-letterPrimary">
              <svg className="w-8 h-8 text-base-content/50#79c2d0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" color='white' strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            </div>
