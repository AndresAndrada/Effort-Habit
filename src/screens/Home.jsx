...
export default function Home() {
  ...
  return (
    <main className={`min-h-screen flex flex-col items-center justify-center px-4 ${DarkMode ? "bg-primary" : "bg-secondary"} pt-8 transition-bg`}>
      <section className={`max-w-2xl w-full text-center space-y-6}`}>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <a href="#servicios" className={`btn btn-outline ${DarkMode ? "bg-secondary" : "bg-tercicario"} btn-lg transition-bg`}>Ver servicios</a>
          <a href="#contacto" className={`btn btn-outline ${DarkMode ? "bg-secondary" : "bg-tercicario"} btn-lg transition-bg`}>Contáctanos</a>
        </div>
      </section>
