  ...
  return (
    <main className={`min-h-screen flex flex-col items-center justify-center pb-8 ${DarkMode ? "bg-primary" : "bg-secondary"} transition-bg`}>
      <section className={`w-full flex items-center justify-center text-center space-y-6 h-screen`}>
        ...
        <div className={`hidden md:flex md:flex-1 w-[50%] relative  flex-col items-center justify-center text-center space-y-6 bg-banner h-screen overflow-hidden bg-cover bg-[position:center]`}>
          <div className="absolute left-0 top-0 h-full w-24 pointer-events-none z-10"
            style={{ background: "linear-gradient(to right, rgba(0,0,0,2.95), rgba(0,0,0,0.9), rgba(0,0,0,0.7), transparent)" }} />
        </div>
      </section>
