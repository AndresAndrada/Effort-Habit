...
export default function Navbar() {
  ...
  return (
    <div className={`navbar ${Ui ? "bg-primary" : "bg-secondary"} shadow-sm`}>
      <div className="flex-1">
        <a className={`btn btn-ghost text-xl ${Ui ? "text-black" : "text-stone-300"}`}>Effort&Habit</a>
      </div>
      <div className="flex-none">
        ...
        <div className='flex items-center gap-2'>
          <label className="swap swap-rotate">
            ...
            <input type="checkbox" className="theme-controller" value="synthwave" onChange={() => setUi(!Ui)} />
            {/* sun icon */}
            <svg
              className="swap-off h-10 w-10"
              fill={Ui ? "#142d4c" : "#ececec"}
