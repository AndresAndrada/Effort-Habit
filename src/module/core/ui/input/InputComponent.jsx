    ...
    return (
        <div className="flex flex-col w-full items-start gap-2">
            ...
            <input
                type="text"
                placeholder={title}
                className={`input w-full bg-white flex p-2 items-center gap-2 rounded-lg text-secondary placeholder-gray-400 focus:border-primary border-2 ${formikTouched && formikError ? 'border-red-500' : 'border-secondary'
                    }`}
                onBlur={formikOnBlur}
